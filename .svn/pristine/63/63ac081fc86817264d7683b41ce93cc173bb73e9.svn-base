package avicit.discussion_manage.mdcsproposalpicture.dto;
...
/**
 * bean MdcsProposalPicture Title: 表MDCS_PROPOSAL_PICTURE的PoJo类，也就是数据库映射类
 * Description: 建议发表截图信息表 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-08-08 17:17
 * 
 */
@PojoRemark(table = "mdcs_proposal_picture", object = "MdcsProposalPictureDTO", name = "建议发表截图信息表")
public class MdcsProposalPictureDTO extends BeanDTO {
	private static final long serialVersionUID = 1L;

	@Id
	@LogField
	@FieldRemark(column = "id", field = "id", name = "表ID")
	private java.lang.String id;

	@FieldRemark(column = "str_id", field = "strId", name = "零件ID")
	private java.lang.String strId;

	@FieldRemark(column = "proposal_id", field = "proposalId", name = "关联建议表ID")
	private java.lang.String proposalId;

	@FieldRemark(column = "save_address", field = "saveAddress", name = "保存地址")
	private java.lang.String saveAddress;

	@FieldRemark(column = "picture_info", field = "pictureInfo", name = "截图")
	private byte[] pictureInfo;
	
	@FieldRemark(column = "picture_option", field = "pictureOption", name = "图片坐标信息")
	private java.lang.String pictureOption;
	...
	public java.lang.String getSaveAddress() {
		return saveAddress;
	}

	public void setSaveAddress(java.lang.String saveAddress) {
	...
	public java.lang.String getPictureOption() {
		return pictureOption;
	}

	public void setPictureOption(java.lang.String pictureOption) {
