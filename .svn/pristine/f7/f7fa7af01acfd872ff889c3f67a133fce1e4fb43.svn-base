package avicit.discussion_manage.factorycomplex.dto;
...
/**
 * bean FactoryComplex Title: 表FACTORY_COMPLEX的PoJo类，也就是数据库映射类 Description:
 * 厂区车间表 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-06-15 15:59
 * 
 */
@PojoRemark(table = "factory_complex", object = "FactoryComplexDTO", name = "厂区车间表")
public class FactoryComplexDTO extends BeanDTO {
	...
	@LogField
	@FieldRemark(column = "strName", field = "strName", name = "装配结构名称")
	private java.lang.String strName;
	@LogField
	@FieldRemark(column = "template", field = "template", name = "模板")
	private java.lang.String template;

	@FieldRemark(column = "workshop_id", field = "workshopId", name = "车间ID")
	private java.lang.String workshopId;
	private java.lang.String workshopIdAlias;

	@FieldRemark(column = "status", field = "status", name = "状态")
	private java.lang.String status;

	@FieldRemark(column = "route_type", field = "routeType", name = "路线类型")
	...
	public java.lang.String getWorkshopIdAlias() {
		return workshopIdAlias;
	}

	public void setWorkshopIdAlias(java.lang.String workshopIdAlias) {
		this.workshopIdAlias = workshopIdAlias;
	}
