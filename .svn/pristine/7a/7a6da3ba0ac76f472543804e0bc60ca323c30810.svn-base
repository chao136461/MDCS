...
/**
 * bean ProcessAssignment Title: 表PROCESS_ASSIGNMENT的PoJo类，也就是数据库映射类
 * Description: 工艺分工人员任务表 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-06-20 10:41
 * 
 */
@PojoRemark(table = "process_assignment", object = "ProcessAssignmentDTO", name = "工艺分工人员任务表")
public class ProcessAssignmentDTO extends BeanDTO {
	private static final long serialVersionUID = 1L;
	//增加审查状态字段
	private java.lang.String taskStatus;//审查状态
	...
	@FieldRemark(column = "status", field = "status", name = "状态（是否已分配分配车间）")
	...
	@FieldRemark(column = "examine_statu", field = "examineStatu", name = "审查任务状态")
	private java.lang.String examineStatu;
	
	

	public java.lang.String getExamineStatu() {
		return examineStatu;
	}

	public void setExamineStatu(java.lang.String examineStatu) {
