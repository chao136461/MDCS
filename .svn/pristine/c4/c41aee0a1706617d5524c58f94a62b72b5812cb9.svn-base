...
<script type="text/javascript">
	...
	function downLoadTemplater(){
		...
		var url = 'platform/discussion_manage/factorycomplex/FactoryComplexController/operation/factoryUser/imports?typeId='+typeId;//服务器请求地址
		...
		if(document.getElementById("impExcelFile").value != ''){
			if(checkfiletype('impExcelFile')){
				...
				$('#uploadExcel').form('submit', {
					url: 'platform/discussion_manage/factorycomplex/FactoryComplexUtil/importFactory',
					success: function(r){
