...
<!-- ControllerPath = "discussion_manage/factorycomplex/FactoryComplexController/FactoryComplexInfo" -->
<title></title>
...
<script type="text/javascript">
	...
	$(function() {
		factoryComplex = new FactoryComplex('dgFactoryComplex', '${url}',
				'searchDialog', 'factoryComplex','${id}','${className}');
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'west'"
		style="background: #ffffff; height: 0;width: 560px;">
		...
		<table id="dgFactoryComplex"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'strName', align:'center'" width="220">装配结构</th>
					...
					<th data-options="field:'routeType', align:'center',formatter:formatrouteType" width="220">路线类型</th>
			...
			<thead>
				<tr>
					<th data-options="field:'id', halign:'center',checkbox:true"
						width="220">ID</th>
					<th data-options="field:'strId', halign:'center',hidden:true" width="220"></th>
					<th data-options="field:'subName', align:'center',hidden:true" width="220">装配结构</th>

					<!-- <th data-options="field:'fcId', halign:'center'" width="220">厂区车间</th>
 -->
					<th data-options="field:'status', align:'center'" width="220">状态(审查确认)</th>
