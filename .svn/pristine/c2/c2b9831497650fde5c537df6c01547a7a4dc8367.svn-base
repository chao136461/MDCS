(function($){
	...
	function setDisabled(target, disabled){
		...
		if (disabled){
			...
			coding.find('.combo-text').attr('disabled', true);
			coding.find('.combo-text').css('cursor', 'default');
			coding.find('.combo-arrow').css('cursor', 'default');
		} else {
			opts.disabled = false;
			$(target).removeAttr('disabled');
			coding.find('.combo-value').removeAttr('disabled');
			coding.find('.combo-text').removeAttr('disabled');
	...
	function setReadonly(target, mode){
		...
		state.coding.find('.combo-text').css('cursor', readonly ? 'default' : 'pointer');
		state.coding.find('.combo-arrow').css('cursor', readonly ? 'default' : 'pointer');
	}
