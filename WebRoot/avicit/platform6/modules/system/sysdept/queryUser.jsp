	...
	<table class="form_commonTable">
		...
		<tr>
			...
			<select class="easyui-combobox"
				data-options="{required:true,panelHeight:120,editable:false,onShowPanel:comboboxOnShowPanel}" name="search_POSITION_ID" id="search_POSITION_ID" style="width: 155px">
