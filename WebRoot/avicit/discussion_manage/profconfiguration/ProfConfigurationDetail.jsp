...
<!-- ControllerPath = "discussion_manage/profconfiguration/ProfConfigurationController/operation/Detail/id" -->
<title>详情</title>
		...
		<form id='form'>
			...
			<table width="100%" style="padding-top: 10px;">
				<tr>
					...
					<td><input title="型号ID" class="inputbox" style="width: 180px;"
						type="text" name="typeId" id="typeId" readonly="readonly"
						value='${profConfigurationDTO.typeId}' /></td>
					<th align="right">类别:</th>
					<td><input title="类别" class="inputbox" style="width: 180px;"
						type="text" name="category" id="category" readonly="readonly"
						value='${profConfigurationDTO.category}' /></td>
				</tr>
				<tr>
					<th align="right">专业:</th>
					<td><input title="{param.field.comment}" class="inputbox"
						style="width: 180px;" type="hidden" name="profession"
						id="profession" />
						<div class="">
