...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="40%"><input title="备忘内容"
						...
						type="text" name="disText" id="disText"
						value='<c:out value='${disputeMemoDTO.disText}'/>' /></td>
				</tr>
				<tr>
					<th width="10%">通知接收目标人:</th>
					<td width="40%"><input title="通知接收目标人" class="inputbox"
						style="width: 182px;" type="hidden" name="sendTo" id="sendTo"
						value='${disputeMemoDTO.sendTo}' />
						<div class="">
							<input class="easyui-validatebox" name="sendToAlias"
								id="sendToAlias" readOnly="readOnly"
								value='<c:out  value='${disputeMemoDTO.sendToAlias}'/>'
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.disputeMemo.closeDialog("#edit");
		}
		function saveForm() {
			...
			parent.disputeMemo.save(serializeObject($('#form')), "#edit");
		}
	</script>
</body>
</html>