...
<!-- ControllerPath = "discussion_manage/factorycomplex/FactoryComplexController/operation/sub/Add/null" -->
<title>娣诲姞</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="id" /> <input type="hidden" name="fcId"
				id="fcId" value='${pid}' />
			<table class="form_commonTable">
				<tr>
					<th width="12%"><span style="color: red;">*</span> 装配结构:</th>
					<td width="38%"><input title="装配结构ID"
						class="easyui-validatebox"
						data-options="required:true,validType:'maxLength[32]'"
						style="width: 180px;" type="text" name="strId" id="strId" /></td>
					<th width="12%">状态(审查确认):</th>
					<td width="38%"><input title="状态(审查确认)"
				...
				<tr>
					...
					<td width="40%"><input title="审查人员所在部门" class="inputbox"
						style="width: 182px;" type="hidden" name="dutyDeptId"
						id="dutyDeptId" />
						<div class="">
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.factoryCensorManage.closeDialog("#insert");
		}
		function saveForm() {
