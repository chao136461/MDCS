...
<!-- ControllerPath = "discussion_manage/processassignment/ProcessAssignmentController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<th width="10%"><span class="remind">*</span> 装配结构ID:</th>
					...
					<td width="40%"><!-- <input title="任务类型"
						...
						type="text" name="taskType" id="taskType" /> -->
						<pt6:syslookup name="taskType" isNull="true"
							lookupCode="PLATFORM_TASK_TYPE"
				...
				<tr>
					...
					<td width="40%"><input title="发出时间" class="easyui-datebox"
						...
						name="publicationTime" id="publicationTime" /></td>

					<th width="10%">状态（是否已分配分配车间）:</th>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.processAssignment.closeDialog("#insert");
		}
		function saveForm() {
			...
			parent.processAssignment.save(serializeObject($('#form')),
					"#insert");
		}
	</script>
</body>
