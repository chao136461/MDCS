...
/**
 * bean FactoryCensorManage Title: 表FACTORY_CENSOR_MANAGE的PoJo类，也就是数据库映射类
 * Description: 厂区审查人员管理 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-06-15 15:59
 * 
 */
@PojoRemark(table = "factory_censor_manage", object = "FactoryCensorManageDTO", name = "厂区审查人员管理")
public class FactoryCensorManageDTO extends BeanDTO {
	...
	@LogField
	@FieldRemark(column = "subName", field = "subName", name = "装配结构名称")
	private java.lang.String subName;

	@FieldRemark(column = "fc_id", field = "fcId", name = "厂区车间ID")
	...
	@FieldRemark(column = "duty_dept_id", field = "dutyDeptId", name = "审查人员所在部门")
	...
	public java.lang.String getFcId() {
		return fcId;
	}

	public void setFcId(java.lang.String fcId) {
		this.fcId = fcId;
	}
