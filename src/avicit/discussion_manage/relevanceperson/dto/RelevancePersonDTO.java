package avicit.discussion_manage.relevanceperson.dto;
...
/**
 * bean RelevancePerson Title: 表RELEVANCE_PERSON的PoJo类，也就是数据库映射类 Description:
 * 关联人员表 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-08-06 14:38
 * 
 */
@PojoRemark(table = "relevance_person", object = "RelevancePersonDTO", name = "关联人员表")
public class RelevancePersonDTO extends BeanDTO {
