package avicit.discussion_manage.profconfiguration.dto;
...
/**
 * bean ProfConfiguration Title: 表PROF_CONFIGURATION的PoJo类，也就是数据库映射类
 * Description: 专业配置表 Copyriht: Copyright (c) 2012 Company: AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2017-07-22 10:12
 * 
 */
@PojoRemark(table = "prof_configuration", object = "ProfConfigurationDTO", name = "专业配置表")
public class ProfConfigurationDTO extends BeanDTO {
	...
	@FieldRemark(column = "category", field = "category", name = "类别")
	private java.lang.String category;

	@FieldRemark(column = "profession", field = "profession", name = "专业")
	private java.lang.String profession;
	private java.lang.String professionAlias;
	...
	@FieldRemark(column = "scene", field = "scene", name = "场所")
	...
	public java.lang.String getProfessionAlias() {
		return professionAlias;
	}

	public void setProfessionAlias(java.lang.String professionAlias) {
		this.professionAlias = professionAlias;
	}
